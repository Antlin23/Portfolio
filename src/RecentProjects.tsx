...
const RecentProjects = () => {
  var wordGeneratorToolLogos: Array<string> = [];
  wordGeneratorToolLogos.push(flutterLogo, dartLogo);

  var panicBtnToolLogos: Array<string> = [];
  panicBtnToolLogos.push(htmlLogo, cssLogo, netLogo, jsLogo);

  var kulturnattenToolLogos: Array<string> = [];
  kulturnattenToolLogos.push(netLogo, cSharpLogo, tailwindLogo, tsLogo);

  var fixoToolLogos: Array<string> = [];
  fixoToolLogos.push(netLogo, mssqlLogo, swishLogo, sendGridLogo);
  return (
      <>
        <Project 
          Title='kulturnatten.uppsala.se'
          Description='Was part of dev team from start to finish.'
          LinkSvg={
